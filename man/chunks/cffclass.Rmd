...
[as_cff()] converts a `list` to `cff` and removes items that are `NULL` or
`NA`. These items are known as `keys` in CFF terminology.
...
- `definitions.reference` is the CFF definition for collecting
