...
[@druskat2021] (v1.2.0) are plain text files with human- and machine-readable
citation information for software (and datasets). Code developers can include
them in their repositories to let others know how to correctly cite their
software.
...
full support of this citation format [@druskat2021a]. GitHub support is of
special interest:
...
See [some projects already using **cffr**](https://github.com/search?l=&o=desc&q=cffr+extension%3Acff+filename%3ACITATION&s=indexed&type=Code).
