...
This is a basic example which shows you how to create a `cff` object [see `?cff` for more
info:
...
<details><summary>
<strong><code>cff</code> object</strong></summary>
...
`cffr::cff_write()`, that creates a `cff` object, write it on a `CITATION.cff`
