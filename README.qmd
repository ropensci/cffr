...
`CITATION.cff` files automatically for **R** packages. It also includes tools
...
customizing `CITATION.cff` files and integrating them into your workflows.
...
See the
[reference documentation](https://docs.ropensci.org/cffr/reference/index.html)
and
