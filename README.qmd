...
![GitHub citation support announcement](vignettes/tweet-1.png){.mx-auto .d-block fig-align="center" width="400"}
...
Actions. Use the `cff_gha_update()` function to install a GitHub Action that will
update your `CITATION.cff` file in the following cases:
...
-   **citation** [@citation22] includes a function `r2cff` that creates a
    ...
    file. It also provides minimal validity checks.
