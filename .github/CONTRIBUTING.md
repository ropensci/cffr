...
- Fork the package and clone it onto your computer. If you have not done this
  before, use `usethis::create_from_github("ropensci/cffr", fork = TRUE)`.
...
- Make your changes, commit them to Git, then create a PR by running
  ...
  `Fixes #issue-number` when the PR closes an issue.
...
- We use [**roxygen2**](https://cran.r-project.org/package=roxygen2) with
  [Markdown syntax](https://roxygen2.r-lib.org/articles/rd-formatting.html) for
  documentation.
