...
between BibTeX and CFF is not possible. Any crosswalk must rely on
...
**cffr** provides utilities for mapping BibTeX entries (with `bibentry()`) to CFF
...
- **\@book**, **\@inbook** and **\@incollection** are closely related in
  ...
  use a combination of these fields to tag each entry type in CFF
  accordingly.
