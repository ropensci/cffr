...
storing references, originally designed for document-centric workflows by Oren
Patashnik and Leslie Lamport in 1985. It represents bibliographic entries as
relatively flat records relying on conventions and free-text fields.
...
Mappings are deterministic whenever possible, but some fields require heuristic
parsing.
...
| BibTeX type     | CFF `type` | Mapping type | Notes                            |
|-----------------|------------|--------------|----------------------------------|
| `@article`      | `article`  | direct       | —                                |
| `@book`         | `book`     | direct       | —                                |
| `@inbook`       | `chapter`  | transform    | Normalized to CFF taxonomy       |
| `@incollection` | `chapter`  | transform    | Same as `inbook`                 |
| `@manual`       | `manual`   | direct       | —                                |
| `@misc`         | `generic`  | heuristic    | Fallback when no better match    |
| `@phdthesis`    | `thesis`   | transform    | Thesis type not always preserved |
| `@techreport`   | `report`   | transform    | —                                |
| other           | `generic`  | heuristic    | Default fallback                 |
