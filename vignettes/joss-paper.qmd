...
**cffr** provides utilities to generate and validate `CITATION.cff` files
automatically for **R** [@R_2021] packages by parsing the `DESCRIPTION` file and
`inst/CITATION`. The package also includes utilities and examples for parsing
components such as persons and additional citations, plus vignettes that
