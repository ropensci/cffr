...
format for providing citation metadata for software or datasets in plain text files
...
parsing components such as persons and additional citations. It also includes
several vignettes that illustrate both basic package usage and more technical
