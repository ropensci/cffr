...
[\LaTeX\](<https://en.wikipedia.org/wiki/LaTeX> "LaTeX"). \BibTeX\ was created
by [Oren
...
back in 1985. An example structure of a \BibTeX\ entry would be:
...
+------------------+------------------------+---------------------------------+
| Value of CFF     | BibTeX Entry           | Notes                           |
| key: type        |                        |                                 |
+==================+========================+=================================+
...
| unpublished      | **\@unpublished**      |                                 |
+------------------+------------------------+---------------------------------+
| generic          | **\@misc /             | Under specific conditions, see  |
|                  | \@incollection**       | [Entry Models]                  |
+------------------+------------------------+---------------------------------+
| \<any other      | **\@misc**             |                                 |
| value>           |                        |                                 |
+------------------+------------------------+---------------------------------+
...
|                 |                 | on CFF                                  |
+-----------------+-----------------+-----------------------------------------+
| **month**       | month           | As a fallback, **month** could be       |
|                 |                 | extracted also from **date** (BibLaTeX  |
|                 |                 | field)/ date-published (CFF)            |
+-----------------+-----------------+-----------------------------------------+
| **note**        | notes           |                                         |
+-----------------+-----------------+-----------------------------------------+
...
| **\@Book**         | book             |                                     |
+--------------------+------------------+-------------------------------------+
| **\@InBook**       | book             | For identifying an \@InBook in CFF, |
|                    |                  | assess if **chapter** or            |
|                    |                  | **pages**/start-end information is  |
|                    |                  | available                           |
+--------------------+------------------+-------------------------------------+
| **author\***       | authors          |                                     |
+--------------------+------------------+-------------------------------------+
...
|                    | ction-title      |                                     |
+--------------------+------------------+-------------------------------------+
| **address**        | address property | As a fallback, the field location   |
|                    | of publisher     | (CFF) can be used                   |
+--------------------+------------------+-------------------------------------+
| **edition**        | edition          |                                     |
+--------------------+------------------+-------------------------------------+
| **month**          | month            | As a fallback, **month** could be   |
|                    |                  | extracted also from **date**        |
|                    |                  | (BibLaTeX field)/ date-published    |
|                    |                  | (CFF)                               |
+--------------------+------------------+-------------------------------------+
| **note**           | notes            |                                     |
+--------------------+------------------+-------------------------------------+
...
| **address**             | location         |                                |
+-------------------------+------------------+--------------------------------+
| **month**               | month            | As a fallback, **month** could |
|                         |                  | be extracted also from         |
|                         |                  | **date** (BibLaTeX field)/     |
|                         |                  | date-published (CFF)           |
+-------------------------+------------------+--------------------------------+
| **year**                | year             | As a fallback, **year** could  |
|                         |                  | be extracted also from         |
|                         |                  | **date** (BibLaTeX field)/     |
|                         |                  | date-published (CFF)           |
+-------------------------+------------------+--------------------------------+
