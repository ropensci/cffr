...
The previous crosswalk has the following specifities:

-   **\@book**, **\@inbook** and **\@incollection** are closely related in
    **BibTeX**[^4]. Both **\@inbook** and **\@incollection** are used for
    referencing parts of a **\@book**, but while **\@inbook** is used for citing
    sections, **chapter**s, **pages** or other parts, **\@incollection** is used
    for citing parts with a specific **title**. Since [CFF]{.underline} allows
    keys [type:book]{.underline} and [collection-type: book]{.underline}, we may
    use a combination of those fields for tagging each entry type in
    [CFF]{.underline}.
-   **\@mastersthesis** and **\@phdthesis** would be tagged using a combination
    of [type:thesis]{.underline}t and [thesis-type]{.underline}.
...
[authors]{.underline} is required on CFF, we would use *anonymous*[^7] when
