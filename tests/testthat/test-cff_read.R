...
test_that("cff_read bib", {
  ...
  f1 <- cff_read(f)
  expect_s3_class(f1, c("cffreflist", "cff"), exact = TRUE)
  ...
  f1_2 <- cff_read(f)
  expect_s3_class(f1_2, c("cffreflist", "cff"), exact = TRUE)
...
test_that("cff_read citation messages", {
  ...
  expect_s3_class(s, c("cffreflist", "cff"), exact = TRUE)
})
...
test_that("cff_read CITATION_basic", {
  ...
  expect_s3_class(a_cff, c("cffreflist", "cff"), exact = TRUE)
