...
# Convert a citation only
    ...
    Output
       [1] "reference.00.type"                   
       [2] "reference.00.title"                  
       [3] "reference.00.authors.00.family_names"
       [4] "reference.00.authors.00.given_names" 
       [5] "reference.00.authors.00.email"       
       [6] "reference.00.authors.00.orcid"       
       [7] "reference.00.authors.01.family_names"
       [8] "reference.00.authors.01.given_names" 
       [9] "reference.00.authors.01.affiliation" 
      [10] "reference.00.authors.01.country"     
      [11] "reference.00.authors.02.family_names"
      [12] "reference.00.authors.02.given_names" 
      [13] "reference.00.authors.02.email"       
      [14] "reference.00.authors.03.name"        
      [15] "reference.00.authors.03.date_end"    
      [16] "reference.00.url"                    
      [17] "reference.00.keywords.00"            
      [18] "reference.00.keywords.01"            
      [19] "reference.00.keywords.02"            
      [20] "reference.00.keywords.03"            
      [21] "reference.00.keywords.04"            
      [22] "reference.00.keywords.05"            
      [23] "reference.00.keywords.06"            
      [24] "reference.00.keywords.07"            
      [25] "reference.00.abstract"               
      [26] "reference.00.version"                
