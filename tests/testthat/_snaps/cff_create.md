# Validate all DESCRIPTION files

    
    
    ## Result of validation: All example DESCRIPTION files 
    
                               file result
    1            DESCRIPTION_Rforge   TRUE
    2         DESCRIPTION_bitbucket   TRUE
    3              DESCRIPTION_demo   TRUE
    4   DESCRIPTION_exotic_licenses   TRUE
    5            DESCRIPTION_gitlab   TRUE
    6              DESCRIPTION_good   TRUE
    7  DESCRIPTION_good_readmeinurl   TRUE
    8         DESCRIPTION_installed   TRUE
    9         DESCRIPTION_many_URLs   TRUE
    10           DESCRIPTION_no_URL   TRUE
    11    DESCRIPTION_no_bugreports   TRUE
    12      DESCRIPTION_no_encoding   TRUE
    13   DESCRIPTION_personoverkill   TRUE
    14     DESCRIPTION_plainauthors   TRUE
    15          DESCRIPTION_sysreqs   TRUE
    16         DESCRIPTION_two_URLs   TRUE
    17   DESCRIPTION_twomaintainers   TRUE
    18      DESCRIPTION_with_remote   TRUE
    19        DESCRIPTION_wrongURLS   TRUE
    
    ---

# Snapshot all DESCRIPTION files
    ...
    cff-version: 1.2.0
    message: 'To cite package demodescriptionfile in publications use:'
    type: software
    license:
    - GPL-3.0-or-later
    - MIT
    ...
    - family-names: Salmon
      ...
      orcid: https://orcid.org/0000-0002-2815-0399
    repository-code: https://github.com/ropensci/codemetar
    url: https://github.com/ropensci/codemetar#codemetar
    contact:
    - family-names: Boettiger
      given-names: Carl
      email: cboettig@gmail.com
    ...
    cff-version: 1.2.0
    message: 'To cite package sf in publications use:'
    type: software
    license:
    - GPL-2.0-only
    - MIT
    ...
    cff-version: 1.2.0
    message: 'To cite package essurvey in publications use:'
    type: software
    license: MIT
    ...
    url: http://github.com/ropensci/essurvey
    contact:
    - family-names: Cimentada
      given-names: Jorge
      email: cimentadaj@gmail.com
